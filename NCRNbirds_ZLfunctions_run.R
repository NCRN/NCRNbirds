...
SpeciesRichnessMap(object=NCRN, Dir="./Data",APIkey ="AIzaSyDerv2JQubJ_Dg8_RKBZCeyo5zqsM5USw0", color="red")
...
mapOccupancy(object=NCRN, AOU="AMRO", mixture="P",color="red",APIkey ="AIzaSyDerv2JQubJ_Dg8_RKBZCeyo5zqsM5USw0")
...
mapAbundance(object=NCRN, AOU="NOCA", mixture="P",color="royalblue3", APIkey ="AIzaSyDerv2JQubJ_Dg8_RKBZCeyo5zqsM5USw0")
mapAbundance(object=ANTI, AOU="NOCA", mixture="P",color="royalblue3", APIkey ="AIzaSyDerv2JQubJ_Dg8_RKBZCeyo5zqsM5USw0")
