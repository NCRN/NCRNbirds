...
#' @param points A character vector passed to \code{\link{getBirds}}. The names of one or more points where the data was collected. \code{NA}(the default) meausures richness from all points.
...
#' 
#' @details This function calculates the species richness for a park, group of parks, group of monitoring points etc. Species richness is the number of different species found, regardless of their abundance. The function works by first getting the monitoring data by using the \code{\link{getBirds}} function and then counting the number of unique birds found. All of the options for combining or subsetting data in \code{\link{getBirds}} will work for \code{birdRichness} including subsetting by year and monitoring point. 
#' 
#' @export
