...
setGeneric(name="detectsPlot",function(object,years=NA, points=NA, visits=NA, times=NA, plot_title=NA, point_num= NA, output="total", ...){standardGeneric("detectsPlot")}, signature="object")
