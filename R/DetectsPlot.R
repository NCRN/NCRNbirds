...
setGeneric(name="detectsPlot",function(object,years=NA, points=NA, visits=NA, times=NA, plot_title=NA, point_num= NA, se= FALSE, output="total", ...){standardGeneric("detectsPlot")}, signature="object")
