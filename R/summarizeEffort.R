...
setGeneric(name="summarizeEffort",function(object,#parks= NA, points=NA,AOU=NA,years=NA,times=NA,band=1,visits=NA, max=F, type="count", site=NA, dist=NA, 
                                       #wind =NA, sky= NA, output="dataframe",...
                                       byYear=T, byPoint=F, effort="points", wide=F){standardGeneric("summarizeEffort")}, signature="object")
